...
python sn_DD_opti/deep_rolling_contour.py --cosmoDir cosmo_files_10years --cosmoFile cosmoSN_deep_rolling_2_2_mini_Ny_40 --xaxis nseasons_ultra_unique --yaxis zcomp_ultra_unique --Ny 40
...
python sn_DD_opti/deep_rolling_contour.py --cosmoDir cosmo_files_10years --cosmoFile cosmoSN_deep_rolling_0.80_0.80_2_2_Ny_40 --Ny 40 --plot_legend 1
...
python sn_DD_opti/deep_rolling_contour.py --cosmoDir cosmo_files_10years --cosmoFile cosmoSN_universal_10_Ny_40 --Ny 40
